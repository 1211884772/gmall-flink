...
import com.mumu.bean.TradeTrademarkCategoryUserRefundBean;
...
public class DwsTradeTrademarkCategoryUserRefundWindow {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<TradeTrademarkCategoryUserRefundBean> reduceWithCategory3DS = AsyncDataStream.unorderedWait(reduceWithTmDS,
        ...
        SingleOutputStreamOperator<TradeTrademarkCategoryUserRefundBean> reduceWithCategory2DS = AsyncDataStream.unorderedWait(reduceWithCategory3DS,
        ...
        SingleOutputStreamOperator<TradeTrademarkCategoryUserRefundBean> reduceWithCategory1DS = AsyncDataStream.unorderedWait(reduceWithCategory2DS,
        ...
        reduceWithCategory1DS.addSink(MyClickHouseUtil.getSinkFunction("insert into dws_trade_trademark_category_user_refund_window values (?,?,?,?,?,?,?,?,?,?,?,?,?)"));
